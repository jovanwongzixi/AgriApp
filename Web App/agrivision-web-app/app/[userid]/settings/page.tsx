...
import { AiOutlineProfile, AiOutlineCloud} from 'react-icons/ai'
    ...
    return(
        <div className='h-[100vh-85px] flex flex-row mx-24 mt-4 justify-between'>
            <div className='w-[15%] flex flex-col items-stretch font-medium text-lg'>
                <button className='flex flex-row p-3 items-center justify-start text-[#9C9C9C]'><AiOutlineProfile /><p className='ml-2'>Profile</p></button>
